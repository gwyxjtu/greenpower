...
\end{equation}
\begin{equation}
A(x^{PV}) = a_{PV}\, x_{PV} \leq S^{PV,MAX}
\end{equation}
Where $a_{PV}$ is the land-use intensity (亩/MW; e.g.\ $12/1.1$), and $S^{PV,MAX}$ is the maximum available PV site area (亩; e.g.\ $1500$ for $1\,\mathrm{km}^{2}$).
Where:
